            ...
            <ul className="space-y-3">
              <li>
                <button 
                  ...
                  className="text-gray-400 hover:text-primary transition-colors flex items-center group w-full text-left"
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start text-gray-400">
                ...
                <a href="tel:0756060808" className="hover:text-primary transition-colors">
                  07 5606 0808
                </a>
              </li>
              <li className="flex items-start text-gray-400">
            ...
            <div className="mt-6">
              <a href="/get-support" className="text-gray-400 hover:text-primary transition-colors text-sm flex items-center group">
                Get Support
                <svg className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </a>
              <a href="/faqs" className="text-gray-400 hover:text-primary transition-colors text-sm flex items-center group mt-2">
                FAQs
                <svg className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </a>
              <a href="/#contact" className="text-gray-400 hover:text-primary transition-colors text-sm flex items-center group mt-2">
                Help Center
                <svg className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2026 ServicePanda. All rights reserved.
            </p>
            <div className="flex flex-wrap justify-center gap-6 text-sm">
              ...
              <a href="/code-of-conduct" className="text-gray-400 hover:text-primary transition-colors">Code of Conduct</a>
              <a href="/faqs" className="text-gray-400 hover:text-primary transition-colors">FAQs</a>
